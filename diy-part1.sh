...
echo 'vm.overcommit_ratio = 80' >>package/base-files/files/etc/sysctl.conf
echo 'vm.max_map_count = 65536' >>package/base-files/files/etc/sysctl.conf
...
echo 'net.core.netdev_max_backlog = 100000' >>package/base-files/files/etc/sysctl.conf
echo 'net.netfilter.nf_conntrack_max = 1000000' >>package/base-files/files/etc/sysctl.conf
echo 'net.netfilter.nf_conntrack_tcp_timeout_established = 120' >>package/base-files/files/etc/sysctl.conf
...
echo 'net.ipv4.neigh.default.gc_thresh1 = 2048' >>package/base-files/files/etc/sysctl.conf
echo 'net.ipv4.neigh.default.gc_thresh2 = 4096' >>package/base-files/files/etc/sysctl.conf
echo 'net.ipv4.neigh.default.gc_thresh3 = 8192' >>package/base-files/files/etc/sysctl.conf
...
echo 'net.core.rmem_max = 26214400' >>package/base-files/files/etc/sysctl.conf
echo 'net.core.wmem_max = 26214400' >>package/base-files/files/etc/sysctl.conf
echo 'net.core.rmem_default = 26214400' >>package/base-files/files/etc/sysctl.conf
echo 'net.core.wmem_default = 26214400' >>package/base-files/files/etc/sysctl.conf
...
echo 'net.ipv4.udp_no_check6_rx = 1' >>package/base-files/files/etc/sysctl.conf
echo 'net.ipv4.udp_no_check6_tx = 1' >>package/base-files/files/etc/sysctl.conf
echo 'net.ipv4.ip_no_pmtu_disc = 1' >>package/base-files/files/etc/sysctl.conf
